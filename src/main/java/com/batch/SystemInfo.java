...
public interface SystemInfo {
	...
	public final String QUERY22_06		= "SELECT ISN, SUBSTR(DNO,3) FROM ("
											...
											+ " AND (CASE WHEN SCD_KY ='FP1' THEN SUBSTR(KY3,2,2) ELSE SUBSTR(KY3,1,2) END) >= '70' AND (CASE WHEN SCD_KY ='FP1' THEN SUBSTR(KY3,2,2) ELSE SUBSTR(KY3,1,2) END) <= '99'"
											+ " UNION ALL"
											+ " SELECT RECID, ISN, '20' || KY3 AS DNO, SCD_KY, SLTCD FROM CMSFPTBL WHERE SCD_KY IN ('FP1', 'KR1', 'KRA')"
											+ " AND (CASE WHEN SCD_KY ='FP1' THEN SUBSTR(KY3,2,2) ELSE SUBSTR(KY3,1,2) END) >= '00' AND (CASE WHEN SCD_KY ='FP1' THEN SUBSTR(KY3,2,2) ELSE SUBSTR(KY3,1,2) END) <= '20'"
	...
	public final String QUERY32_06		= "SELECT ISN, SUBSTR(DNO,3) FROM ("
											+ " SELECT RECID, ISN, '19' || KY3 AS DNO, SCD_KY, SLTCD FROM CMSNPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '70' AND SUBSTR(KY3,2,2) <= '99' AND SCD_KY IN ('N10')"
											+ " UNION ALL"
											+ " SELECT RECID, ISN, '20' || KY3 AS DNO, SCD_KY, SLTCD FROM CMSNPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '00' AND SUBSTR(KY3,2,2) <= '20' AND SCD_KY IN ('N10')"
											+ ") T WHERE SLTCD = '0' AND SCD_KY = ? AND RECID > ? ORDER BY DNO LIMIT 10 WITHOUT LOCK NOWAIT";
	...
	public final String QUERY2_2			= "SELECT SCD_KY, SUBSTR(MIN(K3),3), SUBSTR(MAX(K3),3), MAX(HK), COUNT(*) FROM ("
											+ " SELECT SCD_KY, '19' || KY3 AS K3, HK FROM CMSFPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,1,2) >= '70' AND SUBSTR(KY3,1,2) <= '99' AND SCD_KY IN ('KR1','KRA')"
											+ " UNION ALL"
											+ " SELECT SCD_KY, '20' || KY3 AS K3, HK FROM CMSFPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,1,2) >= '00' AND SUBSTR(KY3,1,2) <= '20' AND SCD_KY IN ('KR1','KRA')"
											+ " UNION ALL"
											+ " SELECT SCD_KY, '19' || KY3 AS K3, HK FROM CMSFPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '70' AND SUBSTR(KY3,2,2) <= '99' AND SCD_KY IN ('FP1')"
											+ " UNION ALL"
											+ " SELECT SCD_KY, '20' || KY3 AS K3, HK FROM CMSFPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '00' AND SUBSTR(KY3,2,2) <= '20' AND SCD_KY IN ('FP1')"
	...
	public final String QUERY3_4			= "SELECT SCD_KY, SUBSTR(MIN(K3),3), SUBSTR(MAX(K3),3), MAX(HK), COUNT(*) FROM ("
											+ " SELECT SCD_KY, '19' || KY3 AS K3, HK FROM CMSNPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '70' AND SUBSTR(KY3,2,2) <= '99' AND SCD_KY = 'N10'"
											+ " UNION ALL"
											+ " SELECT SCD_KY, '20' || KY3 AS K3, HK FROM CMSNPTBL WHERE SLTCD = '0' AND SUBSTR(KY3,2,2) >= '00' AND SUBSTR(KY3,2,2) <= '20' AND SCD_KY = 'N10'"
											+ ") T GROUP BY SCD_KY WITHOUT LOCK NOWAIT";
